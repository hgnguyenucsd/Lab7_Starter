...
const router = new Router(function () {
  ...
  const homePage = document.querySelector(".section--recipe-cards");
  homePage.classList.add("shown");

  const expandPage = document.querySelector(".section--recipe-expand");
  expandPage.classList.remove("shown");
});
